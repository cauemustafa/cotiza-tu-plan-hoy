		...
		<footer className='bg-primary text-primary-foreground'>
			<div className='container mx-auto px-4 sm:px-6 lg:px-8 py-12'>
				...
				<div className='mb-8 pb-8 border-b border-primary-foreground/20'>
					<p
						className='text-center font-semibold mb-6 text-primary-foreground/90'
						role='heading'
						aria-level={2}
					>
						Red Prestadores de Servicio
					</p>
				...
				<div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
					...
					<div className='space-y-4'>
						...
						<p className='text-sm text-primary-foreground/90'>Paloma Ramirez</p>
					...
					{/* Quick Links */}
					<div className='space-y-4'>
						<p className='font-semibold' role='heading' aria-level={2}>
							Enlaces Rápidos
						</p>
						<ul className='space-y-2 text-sm'>
							<li>
								<Link
									to='/seguros-individuales'
				...
				<div className='mt-8 pt-8 border-t border-primary-foreground/20 text-center text-sm text-primary-foreground/90 space-y-2'>
					<p>
						© {new Date().getFullYear()} Cotiza Tu Plan Hoy. Todos los derechos
						reservados.
					</p>
					<a
