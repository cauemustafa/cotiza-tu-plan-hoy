...
const Contacto = () => {
	...
	const onSubmit = (values: ContactFormInputs) => {
		...
		const waUrl = `https://wa.me/56928360499?text=${encodeURIComponent(
			message
		)}`;
		...
		toast({
			...
			description:
				'Se abrirá una conversación en WhatsApp para completar tu solicitud.',
		});
	...
	const genericWhatsappUrl = `https://wa.me/56928360499?text=${encodeURIComponent(
				...
				<div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
					<div className='max-w-4xl mx-auto text-center text-white'>
						<h1 className='text-4xl sm:text-5xl font-bold mb-6'>
							Contáctanos y Cotiza tu Plan Hoy
						</h1>

						<p className='text-xl text-white/90'>
							Estamos aquí para ayudarte a encontrar el seguro perfecto para ti
						</p>
					</div>
				</div>
			</section>
										...
										>
											...
											<div>
												...
												<Textarea
													id='message'
													{...register('message')}
													placeholder='Cuéntanos que tipo de seguro necesitas...'
													rows={4}
												/>
												{errors.message && (
													<p className='text-destructive text-xs mt-1'>
