...
const Isapre = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({ title: "¡Gracias por tu solicitud!", description: "Te contactaremos pronto por WhatsApp" });
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <p className="text-xl text-white/90">
                Cotiza planes de isapres en un solo lugar y obtén la mejor cobertura para ti y tu familia.
              </p>
            </div>
          </div>
        </section>
              ...
              <div>
                <Card className="shadow-card">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Completa el formulario y te contactaremos por WhatsApp con opciones personalizadas
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
            ...
            <div className="bg-gradient-to-b from-primary/5 to-white p-8 rounded-lg shadow-lg border border-primary/10 ring-1 ring-primary/5 h-full flex flex-col justify-between min-h-0">
              ...
              <div className="text-center">
                ...
                <a href="https://wa.me/56928360499" target="_blank" rel="noopener noreferrer">
                  <Button size="lg" className="gradient-primary shadow-lg transform hover:-translate-y-0.5 transition">
